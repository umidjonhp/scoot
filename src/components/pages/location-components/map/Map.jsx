...
export const Map = () => {
  return (
    <div className="container mb-[120px]">
      ...
      <div className="flex items-center justify-between gap-[30px] max-md:gap-10 max-md:flex-col max-md:justify-center ">
        <h2 className="text-darkNavy text-5xl font-bold font-spaceMono leading-[48px] w-[30%] max-md:w-[80%] max-md:text-center">Your city not listed?</h2>
