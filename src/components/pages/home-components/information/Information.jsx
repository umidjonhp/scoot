  ...
  return (
    <>
      <div className="overflow-hidden">
        <div className="container mt-[160px] mb-[200px] max-md:mt-[122px] max-md:mb-[145px] ">
          <div className="flex items-center gap-[30px] relative max-md:flex-col max-md:gap-[40px]">
            <span className="absolute bg-lightGrey h-[10px] w-[974px] top-[15%] -left-[18%] max-md:rotate-[90deg] max-md:-left-[63.5%] max-md:-top-[15%]"></span>
            {
              cardes.map((card) => {
                return (
                  <div className="flex flex-col items-start max-md:gap-[79px] max-md:flex-row " key={card.id}>
                    <img src={card.photo} className="w-24 h-24 z-10" />
                    <div className="">
                      <h4 className="text-darkNavy text-2xl font-bold font-spaceMono leading-7 mt-[40px] max-md:mt-0">{card.title}</h4>
