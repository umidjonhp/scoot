...
export const Card = () => {
  return (
    <div className="container">
      <div className="flex items-center gap-[213px] my-[116px] max-md:flex-col-reverse max-md:gap-16 max-md:mb-[120px] max-md:mt-36">
        <div className="flex flex-col gap-6 items-start w-[47%] max-md:w-[85%] max-md:gap-10 max-md:items-center">
          <h2 className="text-darkNavy text-5xl font-bold font-spaceMono leading-[48px] max-md:text-center">Care to join our mission?</h2>
